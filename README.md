...
這是一個圓融《無量壽經》、《華嚴經》與《法華經》教義開發的**數位修行系統**。  
旨在幫助現代行者在娑婆世界中，透過清晰的數位儀軌，將日常修行的福慧資糧，以「借假修真」之善巧，映射於信、願、行位階之進程。並透過圖像化預覽極樂世界的清淨法性，落實「咸修行普賢之德」。

- **獨創『Practice, Visible』修行位階可視化。」**
  
- 「首度以獨特的數學向量圖示，紀錄並呈現行者的菩提資糧與累積念佛。」
...
本系統**不僅提供念佛計數**，更是一個「境隨心轉」的實修與菩薩道資糧轉化位階的平台。
...
### 一、每日定課．動態行持 (Daily Practices)
- **釋尊本師 普賢大願**：每日十功德菩提行/七日普賢十大願行。
- **三轉法輪**：從阿含、般若到唯識，引導行者轉心轉境。
- **發菩提心**：每日發菩提心四宏願，透過點亮華藏三千大世界星辰的視覺觀想，將願力佈滿法界虛空。
- **般若智慧**：系統化佛法問答法陣，藉由抉擇正見破除無明。
- **琉璃淨水**：專注力訓練，象徵洗滌六根塵勞。
- **觀相悟陣**：記憶力訓練，象徵洗滌六根塵勞。
- **八十八佛大懺悔文**：提供語音導讀與儀軌，助每日至誠懺悔、消業增福。
...
- **淨土戒壇**：提供行者在家自行持八關齋戒或瑜伽菩薩戒。
- **菩提淨室**：專屬個人線上念佛菩薩與經文區，提供行者一個念佛與完整統計數據，自性金蓮自行者發菩提心起，隨著累積念佛數，七寶疊加蛻變，終成金蓮。
- **經典微探**：世間新知與法理探微，有感即錄，隨緣增補。
- **頂禮彌陀**：【三身如來 ‧ 體相用】
彌陀的莊嚴琉璃金身與蓮座，並非世俗常見的任何圖檔，而是完全由「純淨的數學座標」交織而成（SVG 向量圖形）。
捨棄便捷的繪圖，是為了達到這座數位道場的「絕對純淨」——零外部圖檔依賴、徹底斷絕版權爭議、維持極致的低熵狀態，且無論如何放大，琉璃金身皆是完美無瑕，絕不失真。 然而，這是一條不容易的開創之路。佛身的每一道金光漸層、每一片蓮瓣的舒展、每一個手印的悲智弧度，都無法使用畫筆揮灑，必須將莊嚴的法相，化作一行行卻絕對精準的數字與貝茲曲線（Bézier curve）。一個座標的微小偏移、一數點的增減，都會牽動整體的莊嚴。 彌陀琉璃金身與整座淨土，是經過無數次的土法煉鋼，在無數的嘗試錯誤中，一步步推算座標、一次次測試光影所淬鍊而出。這不僅是美學的雕琢，這份反覆試錯、對純粹幾近苛求的堅持，即是對法界最至誠的供養。
...
- **無伺服器架構**：純前端、GitHub Pages 託管，無後端、無資料庫。
- **零知識隱私**：不讀取、不傳輸任何用戶資料，所有進度皆儲存於本地裝置。
- **零追蹤**：無廣告、無 Cookies、無任何追蹤腳本。
- **向量美學**：全程使用純 SVG 數學向量圖形，無位圖、無表情符號。
- **PWA 支援**：可一鍵加入手機主畫面，作為離線 App 使用。

---

## 修證階位 | Progression and Ranking

系統階位反映行者從「初發心」到「十德位」的轉化歷程：

- 資糧升等對應《無量壽經》「此處修善一日，勝極樂國百歲」的疾速。
- 視覺圖示隨資糧進階而自然演化，象徵「心隨境轉」→「境隨心轉」。


---

## 授權與流傳 | License and Credits
...
-**The original "Practice, Visible" framework for visualizing spiritual progression.**
- For the first time, reshaping the presentation of spiritual practice records through a unique perspective of code and pure vectors.
- Pioneering the visualization of accumulated practice and Buddha-recitation stages through pure vector aesthetics.
- The Amitabha Sutra states: "One cannot be born in that land with a lack of good roots, blessings, and causal connections."

- The Infinite Life Sutra also states: "Regarding the lower tier... if they awaken the unsurpassable Bodhi mind, single-mindedly focus their thoughts, and recite the name of the Buddha of Infinite Life even ten times, desiring to be born in that land... upon the moment of death, they will see this Buddha in a dream and will be born there."

- Therefore, diligently accumulating merit in this world is by no means falling into the delusion of "clinging to self-power," but rather building upon the absolute bedrock of "100% profound faith in Amitabha's vow of reception."
...
- System levels reflect the practitioner’s journey from initial aspiration toward the Ten Virtue.  
